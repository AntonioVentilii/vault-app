...
export const idlService = IDL.Service({
	...
	estimate_upload_cost: IDL.Func([IDL.Nat64, PaymentType], [IDL.Nat64], []),
	garbage_collect: IDL.Func([], [], []),
	get_download_plan: IDL.Func([FileId], [GetDownloadPlanResult], []),
	get_file_meta: IDL.Func([FileId], [GetFileMetaResult], []),
	get_pricing: IDL.Func([], [PricingConfig], []),
	get_status: IDL.Func([], [CanisterStatus], []),
	get_upload_tokens: IDL.Func([IDL.Vec(IDL.Nat8), IDL.Vec(IDL.Nat32)], [GetUploadTokensResult], []),
	get_usage: IDL.Func([IDL.Opt(IDL.Principal)], [UserState], []),
	list_files: IDL.Func([], [IDL.Vec(FileMeta)], []),
	...
	resolve_share_link: IDL.Func([IDL.Vec(IDL.Nat8)], [GetDownloadPlanResult], []),
