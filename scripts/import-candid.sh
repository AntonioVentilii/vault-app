...
: Import canisters
mkdir -p src/declarations/bucket
download_did https://raw.githubusercontent.com/AntonioVentilii/vault-core/main/src/bucket/bucket.did "bucket.did" "src/declarations/bucket"

mkdir -p src/declarations/directory
download_did https://raw.githubusercontent.com/AntonioVentilii/vault-core/main/src/directory/directory.did "directory.did" "src/declarations/directory"
: Fin
